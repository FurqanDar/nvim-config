return {
  ...
  keys = {
    ...
    { '<leader>dO', function() require('dap').step_out() end,  desc = 'Debug: step [O]ut (capital)' },

    -- Breakpoints
    { '<leader>db', function() require('dap').toggle_breakpoint() end, desc = 'Debug: [B]reakpoint toggle' },
    { '<leader>dB', function()
    ...
    { '<leader>dn', function() require('dap-python').test_method() end,     desc = '[D]ebug [N]earest test method' },
    { '<leader>dc', function() require('dap-python').test_class() end,      desc = '[D]ebug nearest test [C]lass' },
    ...
    dapui.setup({
      ...
      controls = {
        icons = {
          ...
          step_back = 'b', run_last = '▶▶',
          terminate = '⏹', disconnect = '⏏',
        },
      },
    })

    dap.listeners.after.event_initialized['user-dapui'] = function() dapui.open() end
    dap.listeners.before.event_terminated['user-dapui'] = function() dapui.close() end
    dap.listeners.before.event_exited['user-dapui']     = function() dapui.close() end
