return {
  ...
  config = function()
    local parsers = {
      -- Editor / config
      'bash', 'lua', 'luadoc', 'vim', 'vimdoc', 'query', 'regex',
      -- Languages
      'python', 'typescript', 'tsx', 'javascript', 'c',
      -- Markup / data
      'markdown', 'markdown_inline', 'json', 'yaml', 'toml',
      'html', 'css', 'scss',
      -- Tooling / DS / agent-query stack
      'dockerfile', 'sql', 'csv', 'typst',
      -- Git
      'diff', 'gitcommit', 'gitignore', 'gitattributes', 'git_config', 'git_rebase',
    }
